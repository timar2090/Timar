class ColorizeAPI {
    constructor() {
        ...
        this.BASE_URL = 'https://techsz.aoscdn.com/api/tasks/visual/colorization';
    }
    ...
    async createTask(imageUrl, params = {}) {
        ...
        if (params.saturation) formData.append('saturation', params.saturation);
        if (params.contrast) formData.append('contrast', params.contrast);
    ...
    // 执行上色任务
    async performColorize(imageUrl, params = {}) {
        try {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const colorizeAPI = new ColorizeAPI();
        ...
        try {
            ...
            resultDisplay.innerHTML = `
                <div class="loading">
                    ...
                    <div class="loading-text">正在上色中...</div>
                </div>
            `;
            ...
            const result = await colorizeAPI.performColorize(previewImage.src, {
                style,
                saturation,
                contrast
            });
            ...
            // 显示结果
            resultDisplay.innerHTML = `
                <img src="${result.output_url}" alt="上色结果">
